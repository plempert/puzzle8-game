...
public class PuzzleBoard {
    ...
    PuzzleBoard(Bitmap bitmap, int parentWidth) {
        ...
        Log.d(TAG,"PuzzleBoard constructor succeeded.");
    }
...
//                copy.swapTiles(XYtoIndex(x,y),
//                        XYtoIndex(x+1,y));
//                if(copy.isEqualTo(previousBoard))
//            case: x-1 >= 0;
//
//            case: y+1 < NUM_TILES;
//
...
//        }
        ...
        for(int[] tuple : NEIGHBOUR_COORDS){
            if(XYtoIndex(tuple[0]+x,tuple[1]+y) < NUM_TILES*NUM_TILES &&
                ...
                //else Log.d(TAG,"copy was equal to previous board");
                //Log.d(TAG, x+","+y+" "+(tuple[0]+x)+","+(tuple[1]+y));
            }
        }
